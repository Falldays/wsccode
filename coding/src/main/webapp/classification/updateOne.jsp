...
<div id="scrollContent" style="width: 99%">
    <form action="/classification/updateOneClassification" method="post">
        <div class="form-group">
            <div class="row">
                <label class="control-label col-md-2" style="text-align: right;">一级分类编号</label>
                <div class="col-sm-3">
                    <input  class="form-control" type="text" name="claNo" value="${cla.claNo}" required readonly/>
                </div>
                <div class="col-sm-1">
        ...
        <div class="form-group">
            <div class="col-sm-3 text-right">
                <input type="hidden" name="claFid" value="${cla.claFid}"/>
                <button type="submit" class="btn btn-primary" id="submit_button01">
                    <span>确认修改</span></button>
                <a href="../classification/queryClassification"><button type="button" class="btn btn-close" id="submit_button02" ><span>返回</span></button></a>
            </div>
        </div>
        <div class="form-group">
            <div class="left">
