...
<div id="scrollContent" style="width: 99%">
    <form action="/classification/updateTwo" method="post">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <input  class="form-control" type="text" name="pd_twoNo" value="${two.pd_twoNo}" readonly/>
                </div>
                <div class="col-sm-1">
                    <span style="color:rgb(255,0,0)">*</span>
                </div>
        ...
        <div class="form-group">
            <div class="col-sm-3 text-right">
                <input type="hidden" value="${cla.claFid}" name="claFid"/>
                ...
                <a href="../classification/queryTwoClassification"><button type="button" class="btn btn-close" id="submit_button02" ><span>返回</span></button></a>
            </div>
        </div>
        <div class="form-group">
            <div class="left">
